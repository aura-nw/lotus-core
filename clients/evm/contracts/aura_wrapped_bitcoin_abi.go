...
func (_AuraWrappedBitcoin *AuraWrappedBitcoinTransactor) Burn(opts *bind.TransactOpts, amount *big.Int) (*types.Transaction, error) {
	return _AuraWrappedBitcoin.contract.Transact(opts, "burn", amount)
}

// Burn is a paid mutator transaction binding the contract method 0x42966c68.
//
// Solidity: function burn(uint256 amount) returns()
func (_AuraWrappedBitcoin *AuraWrappedBitcoinSession) Burn(amount *big.Int) (*types.Transaction, error) {
	return _AuraWrappedBitcoin.Contract.Burn(&_AuraWrappedBitcoin.TransactOpts, amount)
}

// Burn is a paid mutator transaction binding the contract method 0x42966c68.
//
// Solidity: function burn(uint256 amount) returns()
func (_AuraWrappedBitcoin *AuraWrappedBitcoinTransactorSession) Burn(amount *big.Int) (*types.Transaction, error) {
	return _AuraWrappedBitcoin.Contract.Burn(&_AuraWrappedBitcoin.TransactOpts, amount)
}
